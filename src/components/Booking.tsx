      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7">
            <span className="text-zinc-500 text-xs font-black uppercase tracking-[0.3em] mb-6 block">
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-12 md:mt-16 border-t border-edge pt-8 md:pt-12">
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-mono uppercase tracking-widest text-[9px] text-zinc-600 mb-1">
              ...
              <div className="bg-surface p-8 border border-edge skew-x-[-2deg]">
                <div className="skew-x-[2deg]">
                  <p className="text-brand font-display italic text-2xl mb-2 font-black leading-none uppercase tracking-tighter">
                    &quot;Results are the only valid metric.&quot;
                  </p>
                  <p className="font-mono text-[9px] uppercase text-zinc-600 tracking-widest">
                    — The Mit2Fit Protocol
                  </p>
                </div>
              </div>
            </div>
...
<<<<<<< HEAD
            ...
            <div className="bg-zinc-950 h-full p-6 md:p-12 relative z-10">
              <h3 className="text-2xl font-black uppercase tracking-tighter mb-4 italic">
                Request Protocol <span className="text-brand not-italic">Access</span>
              </h3>
              <p className="text-zinc-500 mb-6 md:mb-8 text-[10px] font-mono uppercase tracking-widest leading-loose">
                ...
                {embedSrc
                  ? ' Prefer a live calendar? Use the scheduler below—otherwise submit your preferred window in the form.'
                  : null}
              </p>
              ...
              {embedSrc ? (
                <motion.div
                  ...
                  className="rounded-sm border border-edge overflow-hidden bg-black min-h-[360px] mb-10"
                >
                  <p className="text-[9px] font-mono uppercase tracking-widest text-zinc-500 px-4 py-3 border-b border-edge bg-black/60">
                    Live schedule (Calendly)
                  </p>
                  <iframe
                    title="Schedule a consultation"
                    src={embedSrc}
                    className="w-full min-h-[520px] h-[50vh] max-h-[720px]"
                    loading="lazy"
                  />
                </motion.div>
              ) : (
                <div className="border border-edge bg-black/40 p-6 text-center space-y-3 mb-10">
                  <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 leading-relaxed">
                    Optional: set <span className="text-zinc-300">VITE_CALENDLY_CONSULT_URL</span> or{' '}
                    <span className="text-zinc-300">VITE_CALENDLY_URL</span> to show the live Calendly embed above this
                    form.
                  </p>
                </div>
              )}

              <p className="text-[9px] font-mono uppercase tracking-widest text-zinc-600 mb-6 border-t border-edge pt-8">
                Request a slot via form (Formspree)
              </p>
...
<<<<<<< HEAD
                    <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-400 leading-loose">
                      <span className="text-white">
                        ...
                        @ {['09:00', '10:30', '13:00', '14:30', '16:00', '17:30'][selectedTime]}
                      </span>
                      <br />
