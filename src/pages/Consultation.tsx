...
import { ChevronRight, ChevronLeft, CheckCircle2, FileText, ShieldAlert, HeartPulse, Utensils, Send, Calendar } from 'lucide-react';
import {
  ...
  return (
    <main className="pt-32 pb-16 md:pt-40 md:pb-32 bg-paper text-ink min-h-screen">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-10 border border-edge bg-zinc-950/80 p-6 md:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="flex gap-4">
            <Calendar className="text-brand shrink-0 mt-0.5" size={22} />
            <div>
              <p className="text-[10px] font-black uppercase tracking-widest text-brand mb-2">Schedule first</p>
              <p className="text-[10px] font-mono uppercase tracking-widest text-zinc-500 leading-relaxed max-w-xl">
                Book your strategy slot if you have not already, then complete the intake steps below.
              </p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <Link
              to="/#book"
              className="text-center border border-edge text-[10px] font-black uppercase tracking-widest text-white px-6 py-3 hover:border-brand hover:text-brand transition-colors"
            >
            ...
            {scheduleUrl ? (
              <button
                type="button"
                onClick={() => void openCalendlyPopup(scheduleUrl)}
                className="text-center bg-brand text-black text-[10px] font-black uppercase tracking-widest px-6 py-3 hover:brightness-110 transition-all"
              >
                Open calendar
              </button>
            ) : null}
